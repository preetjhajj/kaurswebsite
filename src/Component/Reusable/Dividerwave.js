...
function Dividerwave() {
    const divfirst = {
        stopColor: "rgba(22, 146, 173, 0.06)"
    }
    const divsec = {
        stopColor: "rgba(55, 161, 184, 0.6)"
    }
    const divthird = {
        stopColor: "rgba(255, 145, 145, 0.2)"
    }
  return (
    <>
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg"
		...
		<defs>
			<linearGradient id="bg">
				<stop offset="0%" style={divfirst}></stop>
				<stop offset="50%" style={divsec}></stop>
				<stop offset="100%" style={divthird}></stop>
			</linearGradient>
